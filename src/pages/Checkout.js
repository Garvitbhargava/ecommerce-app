...
import { createAnOrder, deleteUserCart, getUserCart, resetState } from '../feature/user/userSlice'
 ...
 for( let index= 0; index< cartState?.length; index++ ){
   ...
   setCartProductState(items)
      ...
      const checkOutHandler = async () => {
        ...
        const options = {
            key: "rzp_test_E9BEq0z4GI4cRF", // Enter the Key ID generated from the Dashboard
            amount: amount?.toString(),
            currency: currency,
            name: "Rachit Computers",
...
dispatch(resetState())
            ...
            prefill: {
                name: "Garvit Bharagva",
                email: "GarvitBh@example.com",
                contact: "9999999999",
            },
            notes: {
                address: "Rachit Computer's Office",
            },
            theme: {
                color: "#61dafb",
            },
...
<p className='user-details'>
    Garvit Bhargava (garvitbhargava@gmail.com)
</p>
...
<div className='w-100'>
    <div className='d-flex justify-content-between align-items-center'>
      <Link to='/cart' className='text-dark'><BiArrowBack className='me-2'/>
      Return to Cart</Link>  
