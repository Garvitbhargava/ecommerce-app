...
import { addProdToCart, getUserCart } from '../feature/user/userSlice';
...
const uploadCart = () => {
 ...
 <BreadCrump title="Dynamic Product Name" />
           ...
           // data-bs-toggle="model"
            ...
            <button className='button border-0 signup'> Buy It Now</button>
                      ...
                      <div className='d-flex align-items-center gap-15'>
                        ...
                        <div>
                          <a href=''>
                            <AiOutlineHeart className='fs-5 me-2'/>Add to cart</a>
                        </div>
                      </div>
 ...
 <Container  class1='reviews-wrapper  home-wrapper-2'>
        ...
        <div className='row'>
            <div className='col-12'>
              ...
              <button className='button border-0'>Sumbit Review</button>
              </div>
               </form>
                </div>
                <div className='reviews mt-4'>
                  ...
                  <ReactStars count={5} 
                    size={24} 
                     ...
                     <p className='mt-3' >lorem sapn idnd fejhfbeufhkc jdsdcjn</p>
                    </div>
                </div>
               </div>
            </div>
